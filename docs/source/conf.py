...
# sphinx-quickstart on Mon Sep  7 22:48:24 2020.
#
...
latex_documents = [
    (master_doc, 'recon.tex', 'recon Documentation',
     'Lucas Plagwitz', 'manual'),
]
...
man_pages = [
    (master_doc, 'recon', 'recon Documentation',
     [author], 1)
]
